...
# 4
# a = str(input("Введите четырех значное число: "))
# print(a[0],a[1],a[2],a[3])

# 5
# a = str(input("Введите ваше имя: "))
# b = str(input("Введите вашу фамилию: "))
# c = int(input("Введите вашь возраст: "))
# print(a)
# print(b)
# print(c)
...
# автоматизируя процесс. В каждом цикле есть условие и блок кода,
# которые выполняются, пока условие истинно.
# С помощью циклов for можно итерировать коллекции данных, выполняя преобразования.

# 17
# a = [1, 2, 3, 4, 5] #Создание списка
# print(a[0])  # Вывод первого элемента
# a[0] = 6  # Замена первого элемента на 6
# a.append(6)  # Добавление элемента в конец
# del a[0]  # Удаление первого элемента
# subset = a[1:3]  # Выборка подсписка

# if 6 in a:
#     print("6 в списке") #Проверка на наличие эдемента
# b = len(a)  # Количество элементов в списке
# c = a + [7, 8, 9] #Соединение листов
